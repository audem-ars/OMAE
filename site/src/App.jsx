...
export default function App() {
  return (
    <>
      {/* Lightweight, self-contained styles so it looks polished without extra setup */}
      <style>{`
        :root {
          --bg: #0b0f14;
          --bg-soft: #0f141b;
        ...
        * { box-sizing: border-box; }
        ...
        .badge {
          ...
          color:#fff; border-radius:8px; font-weight:900;
        ...
        .btn {
          ...
          padding: 10px 16px; border-radius: 10px; font-weight:700; gap:8px;
        ...
        .hero h1 {
          ...
          line-height: 1.02; margin: 8px 0 14px;
      ...
      <header className="container hero">
        <div style={{ textAlign: "center" }}>
          ...
          <p>
            Acme is the all-in-one platform to plan, build, and launch. Real-time
            collaboration, lightning-fast previews, and zero-config deploys.
          </p>
          ...
          <div className="logo-row">
            <span>YouTube</span>·<span>Stripe</span>·<span>Figma</span>·
            <span>Linear</span>·<span>Vercel</span>·<span>OpenAI</span>
          </div>
        </div>
      </header>
      ...
      <section id="features" className="container section">
        <div style={{ textAlign: "center" }}>
          ...
          <p className="muted">
            Designed for product teams that value speed without sacrificing quality.
          </p>
        </div>
        ...
        <div className="cards" style={{ marginTop: 24 }}>
          <article className="card feature">
            ...
            <div>
              ...
              <p className="muted">
                Edit together, comment in context, and never lose track.
              </p>
            </div>
          </article>
          <article className="card feature">
            <div className="dot" />
            <div>
              <h3>Blazing previews</h3>
              <p className="muted">
                Every commit gets a shareable live URL backed by edge caching.
              </p>
            </div>
          </article>
          <article className="card feature">
            ...
            <div>
              ...
              <p className="muted">
                Connect your repo and ship to production automatically.
              </p>
            </div>
          </article>
        </div>
      ...
      <section id="pricing" className="container section price-cards">
        ...
        <div className="cards" style={{ marginTop: 24 }}>
          ...
          <article className="card price-col" style={{ borderColor: "rgba(79,140,255,.45)" }}>
            ...
            <div style={{ marginTop: 16 }}>
              <a className="btn btn-primary" href="/OMAE/apps/studio/">Start Pro</a>
            </div>
          </article>
          ...
          <article className="card price-col">
            ...
            <div style={{ marginTop: 16 }}>
              <a className="btn" href="/OMAE/apps/studio/">Contact Sales</a>
            </div>
          </article>
        </div>
      ...
      <section id="faq" className="container section">
        ...
        <div className="cards" style={{ marginTop: 24 }}>
          <article className="card">
            <h3>Can I deploy anywhere?</h3>
            <p className="muted">
              Yes — GitHub Pages by default, or any CDN via manual upload.
            </p>
          </article>
          <article className="card">
            <h3>Do you have a free tier?</h3>
            <p className="muted">Starter is free forever for individuals.</p>
          </article>
          <article className="card">
            <h3>Is it fast?</h3>
            <p className="muted">
              Built with Vite and edge caching — previews are instant.
            </p>
          </article>
        </div>
      </section>
